...
## 🔧 Tools & Libraries
- [chess.js](https://github.com/jhlywa/chess.js) - Chess logic library (move validation, check/checkmate detection, FEN notation) - **ESSENTIAL**
...
## 📖 Learning Resources
- [FEN Notation Explained](https://www.chess.com/terms/fen-chess) - Learn Forsyth-Edwards Notation for board positions
- [Algebraic Chess Notation](https://www.chess.com/terms/algebraic-notation) - Understanding move notation (e.g., Nf3, O-O)
- [JavaScript Array Methods](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) - Essential for board representation (2D arrays)
- [Drag and Drop API](https://developer.mozilla.org/en-US/docs/Web/API/HTML_Drag_and_Drop_API) - MDN guide for implementing piece movement
- [LocalStorage API](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage) - Save game states locally

## 🌐 Rules & Logic References
- [Chess Rules on Chess.com](https://www.chess.com/learn-how-to-play-chess) - Complete rules for implementation reference
- [FIDE Laws of Chess](https://www.fide.com/FIDE/handbook/LawsOfChess.pdf) - Official chess rules (PDF)
- [Chess Programming Wiki](https://www.chessprogramming.org/Main_Page) - Advanced resource for chess algorithms (optional)

## 🎨 Assets & Design
- [Wikimedia Chess Pieces](https://commons.wikimedia.org/wiki/Category:PNG_chess_pieces/Standard_transparent) - Free transparent PNG chess pieces
- [Chess Board CSS Grid Templates](https://codepen.io/search/pens?q=css+chess+board) - CodePen inspiration for board styling
- [Google Fonts: Chess Typefaces](https://fonts.google.com/specimen/Cinzel) - Styling for move notation display
- [SVG Chess Pieces](https://commons.wikimedia.org/wiki/Category:SVG_chess_pieces) - Scalable vector graphics for pieces

## 🎓 Additional Concepts
- [Minimax Algorithm Explained](https://www.freecodecamp.org/news/minimax-algorithm-guide-how-to-create-an-unbeatable-ai/) - For creating AI opponent (intermediate)
- [Game State Management in JS](https://gamedevjs.com/tutorials/state-management-javascript-games/) - Managing game turns and state
- [Event Delegation](https://javascript.info/event-delegation) - Efficient event handling for 64 board squares